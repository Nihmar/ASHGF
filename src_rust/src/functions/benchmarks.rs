...
impl Function {
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        match name.to_lowercase().as_str() {
            "sphere" => Some(Function::Sphere),
            "power" => Some(Function::Power),
            "extended_rosenbrock" => Some(Function::ExtendedRosenbrock),
            "generalized_rosenbrock" => Some(Function::GeneralizedRosenbrock),
            "extended_white_and_holst" => Some(Function::ExtendedWhiteAndHolst),
            "generalized_white_and_holst" => Some(Function::GeneralizedWhiteAndHolst),
            "extended_feudenstein_and_roth" => Some(Function::ExtendedFeudensteinAndRoth),
            "extended_baele" => Some(Function::ExtendedBaele),
            "extended_penalty" => Some(Function::ExtendedPenalty),
            "perturbed_quadratic" => Some(Function::PerturbedQuadratic),
            "almost_perturbed_quadratic" => Some(Function::AlmostPerturbedQuadratic),
            "perturbed_quadratic_diagonal" => Some(Function::PerturbedQuadraticDiagonal),
            "generalized_tridiagonal_1" => Some(Function::GeneralizedTridiagonal1),
            "extended_tridiagonal_1" => Some(Function::ExtendedTridiagonal1),
            "diagonal_4" => Some(Function::Diagonal4),
            "extended_himmelblau" => Some(Function::ExtendedHimmelblau),
            "extended_psc1" => Some(Function::ExtendedPsc1),
            "sin_cos" | "sincos" => Some(Function::SinCos),
            "extended_bd1" => Some(Function::ExtendedBd1),
            "extended_maratos" => Some(Function::ExtendedMaratos),
            "extended_cliff" => Some(Function::ExtendedCliff),
            "extended_hiebert" => Some(Function::ExtendedHiebert),
            "quadratic_qf1" => Some(Function::QuadraticQf1),
            "quadratic_qf2" => Some(Function::QuadraticQf2),
            "extended_quadratic_penalty_qp1" => Some(Function::ExtendedQuadraticPenaltyQp1),
            "extended_quadratic_penalty_qp2" => Some(Function::ExtendedQuadraticPenaltyQp2),
            "extended_quadratic_exponential_ep1" => Some(Function::ExtendedQuadraticExponentialEp1),
            "extended_tridiagonal_2" => Some(Function::ExtendedTridiagonal2),
            "fletchcr" => Some(Function::Fletchcr),
            "tridia" => Some(Function::Tridia),
            "arwhead" => Some(Function::Arwhead),
            "nondia" => Some(Function::Nondia),
            "nondquar" => Some(Function::Nondquar),
            "dqdrtic" => Some(Function::Dqdrtic),
            "broyden_tridiagonal" => Some(Function::BroydenTridiagonal),
            "liarwhd" => Some(Function::Liarwhd),
            "engval1" => Some(Function::Engval1),
            "edensch" => Some(Function::Edensch),
            "cube" => Some(Function::Cube),
            "nonscomp" => Some(Function::Nonscomp),
            "vardim" => Some(Function::Vardim),
            "quartc" => Some(Function::Quartc),
            "sinquad" => Some(Function::Sinquad),
            "extended_denschnb" => Some(Function::ExtendedDenschnb),
            "extended_denschnf" => Some(Function::ExtendedDenschnf),
            "dixon3dq" => Some(Function::Dixon3dq),
            "cosine" => Some(Function::Cosine),
            "sine" => Some(Function::Sine),
            "biggsb1" => Some(Function::Biggsb1),
            "generalized_quartic" => Some(Function::GeneralizedQuartic),
            "diagonal_5" => Some(Function::Diagonal5),
            "diagonal_7" => Some(Function::Diagonal7),
            "diagonal_8" => Some(Function::Diagonal8),
            "fh3" => Some(Function::Fh3),
            "diagonal_9" => Some(Function::Diagonal9),
            "himmelbg" => Some(Function::Himmelbg),
            "himmelh" => Some(Function::Himmelh),
            "ackley" => Some(Function::Ackley),
            "griewank" => Some(Function::Griewank),
            "levy" => Some(Function::Levy),
            "rastrigin" => Some(Function::Rastrigin),
            "schwefel" => Some(Function::Schwefel),
            "sum_of_different_powers" => Some(Function::SumOfDifferentPowers),
            "trid" => Some(Function::Trid),
            "zakharov" => Some(Function::Zakharov),
            "extended_trigonometric" => Some(Function::ExtendedTrigonometric),
            "eg2" => Some(Function::Eg2),
            "indef" => Some(Function::Indef),
            "genhumps" => Some(Function::Genhumps),
            "mccormck" => Some(Function::Mccormck),
            "fletcbv3" => Some(Function::Fletcbv3),
            "bdqrtic" => Some(Function::Bdqrtic),
            "bdexp" => Some(Function::Bdexp),
            "raydan_1" => Some(Function::Raydan1),
            "raydan_2" => Some(Function::Raydan2),
            "diagonal_1" => Some(Function::Diagonal1),
            "diagonal_2" => Some(Function::Diagonal2),
            "diagonal_3" => Some(Function::Diagonal3),
            "hager" => Some(Function::Hager),
            _ => None,
        }
    }
}
