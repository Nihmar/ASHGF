...
from ashgf.algorithms import (
    ...
    ASGF2S, ASGF2SA, ASGF2SAW, ASGF2SD, ASGF2SG, ASGF2SL, ASGF2SLA, ASGF2SLB, ASGF2SLD, ASGF2SLP, ASGF2SLR, ASGF2SLS, ASGF2SLT, VOTE, VOTEKA, VOTEKC, VOTEKM, VOTEKMA, VOTEKMB, VOTEKMBA, VOTEKMBBH, VOTEKMBR, VOTEKMBS, VOTEKMBSR, VOTEKMBT, VOTEKMH, VOTEKML, VOTEKR, VOTEV2, VOTEV2P, VOTEV2PS, VOTEV2S, VOTES, VOTEK, VOTEM, VOTEP, VOTEPS, VOTEB,
    ...
    ASGFRS, ASGFSS, ASHGF, ASHGF2F, ASHGF2FD,     ASHGF2SMA, ASHGFVOTE, ASHGFVOTE0, ASHGFVOTE2G, ASHGFVOTE2GA, ASHGFVOTE2GD, ASHGFVOTEA, ASHGF2X, ASHGFD, ASHGFNG, ASHGFS, GD, SGES,
)
...
ALGORITHMS = {
    ...
    "vote-kma": VOTEKMA,
    "vote-kmb": VOTEKMB,
    "vote-kmbbh": VOTEKMBBH,
    "vote-kmba": VOTEKMBA,
    "vote-kmbr": VOTEKMBR,
    "vote-kmbs": VOTEKMBS,
    "vote-kmbsr": VOTEKMBSR,
    "vote-kmbt": VOTEKMBT,
    "vote-kr": VOTEKR,
    "vote-m": VOTEM,
    "vote-v2": VOTEV2,
    ...
    "ashgf-vote": ASHGFVOTE,
    "ashgf-vote0": ASHGFVOTE0,
    "ashgf-vote2g": ASHGFVOTE2G,
    "ashgf-vote2ga": ASHGFVOTE2GA,
    "ashgf-vote2gd": ASHGFVOTE2GD,
    "ashgf-votea": ASHGFVOTEA,
    "ashgf-2x": ASHGF2X,
    "ashgf-d": ASHGFD,
    "asgf-cd": ASGFCD,
    "asgf-ss": ASGFSS,
